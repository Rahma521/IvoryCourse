<?php
    $today_followups = App\ClientFollowUps::where('UID',auth()->user()->id)->where('status','pinding')->where('contactingDateTime',date('Y-m-d'))->get();
?>
<li class="nav-item dropdown dropdown-notification me-25">
    ...
    <ul class="dropdown-menu dropdown-menu-media dropdown-menu-end">
        ...
        <li class="dropdown-menu-footer">
            <a class="btn btn-primary w-100" href="">{{trans('common.Read all notifications')}}</a>
        </li>
    </ul>
</li>
